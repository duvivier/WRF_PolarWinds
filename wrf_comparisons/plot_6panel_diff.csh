...
set tag2 = 'PW-05-40-U-bn'
set tag3 = 'PW-10-40-U-bn'
...
set outdir1 = $rundir'figures/WRF_pbl_compare/Denmark_Strait'
set outdir2 = $rundir'figures/WRF_pbl_compare/Greenland'
mkdir -p $outdir1
mkdir -p $outdir2
